...
export class Scrollview extends Component{
	...
	onAutoScroll(){
		...
		if(this.props.onAutoScroll){if(this.props.onAutoScroll.canExecute&&this.props.onAutoScroll.isAuthorized&&!(this.props.onAutoScroll.isExecuting&&this.props.onAutoScroll.disabledDuringExecution)){
	...
	onScrollBottom(){
		...
		if(this.props.onScrollBottom){if(this.props.onScrollBottom.canExecute&&this.props.onScrollBottom.isAuthorized&&!(this.props.onScrollBottom.isExecuting&&this.props.onScrollBottom.disabledDuringExecution)){
	...
	onScrollTop(){
		...
		if(this.props.onScrollTop){if(this.props.onScrollTop.canExecute&&this.props.onScrollTop.isAuthorized&&!(this.props.onScrollTop.isExecuting&&this.props.onScrollTop.disabledDuringExecution)){
